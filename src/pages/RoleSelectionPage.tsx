...
export function RoleSelectionPage() {
  return (
    <main className="min-h-dvh flex flex-col items-center justify-start sm:justify-center bg-background px-4 pt-[max(2rem,env(safe-area-inset-top))] pb-[max(2rem,env(safe-area-inset-bottom))] sm:py-12 w-full min-w-0">
