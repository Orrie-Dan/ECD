export const common = {
  appName: "Sisitemu y'Imbonezamikurire y'Abana Bato",
  ...
  excelExport: {
    success: 'Raporo ya Excel yakuwe.',
    failed: 'Ntibyashoboye gukora dosiye ya Excel. Ongera ugerageze.',
    pdfUnavailable: 'Kuramo PDF ntabwo bishoboka muri iki gihe.',
    clientSide: 'Dosiye ya Excel ikorwa kuri iki gikoresho.',
    mockDataNote: 'Amakuru y\'ikigerageza — si amakuru ya production.',
    generatedAt: 'Itariki yakozweho',
    centre: 'Ikigo',
    classroom: 'Umwaka',
    totals: 'Igiteranyo',
    sheetSummary: 'Incamake',
    sheetCenters: 'Ibigo',
    sheetAttendance: 'Ubwitabire',
    sheetNutrition: 'Imikurire',
    sheetEnrollment: 'Kwiyandikisha',
    sheetDropouts: 'Abaretse gahunda',
    sheetTransfers: 'Koherezwa',
    sheetReferrals: 'Ihererekanya',
    districtScope: 'Akarere',
    pageScope: 'Ipaji {page} muri {totalPages} ({total} inyandiko)',
    metric: 'Igipimo',
    value: 'Agaciro',
    sourceLive: 'Amakuru ya API',
    sourceMock: 'Amakuru y\'ikigerageza',
    dataSource: 'Inkomoko',
  },
  gis: {
