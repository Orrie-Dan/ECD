...
export type NotificationResponseDtoPriority = typeof NotificationResponseDtoPriority[keyof typeof NotificationResponseDtoPriority];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const NotificationResponseDtoPriority = {
  low: 'low',
  medium: 'medium',
  high: 'high',
  critical: 'critical',
