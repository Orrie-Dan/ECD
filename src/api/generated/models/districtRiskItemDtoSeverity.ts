...
export type DistrictRiskItemDtoSeverity = typeof DistrictRiskItemDtoSeverity[keyof typeof DistrictRiskItemDtoSeverity];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const DistrictRiskItemDtoSeverity = {
  normal: 'normal',
  watch: 'watch',
  concern: 'concern',
  critical: 'critical',
